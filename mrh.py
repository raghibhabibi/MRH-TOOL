...
if pilih == "1":
    ...
    if pilih == "1":
        ...
        if pilih == "1":
            ...
            print "   yaitu simbol-simbol yang mewakili suatu"
            print "   bilangan pada suatu bentuk aljabar"
            print "2. Koefisien "
            print "   yaitu suatu bilangan yang menyetai variabel"
            print "3. Konstanta"
            print "   yaitu bagian dari bentuk aljabar yang tidak"
            print "   memuat variabel"
            print "4. Suku"
            print "   yaitu bagian dari bentuk aljabar yang berupa"
            print "   variabel beserta koefisien/konstanta "
            print "   yang dipisahkan - atau +"
elif pilih == "3":
    print ""
    print "WA = +62852 1707 8508"
    print "INSTAGRAM = @raghibhabibi"
